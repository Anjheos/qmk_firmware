...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   /* Keymap _BL: Default Layer
    */
[_DL] = LAYOUT_SplitBackspace_default(
	...
	KC_CAPS, KC_A,    KC_S,  KC_D,   KC_F,  KC_G,  KC_H,  KC_J,  KC_K,  KC_L,    KC_SCLN, KC_QUOT, KC_NUHS, KC_BSPC, KC_PGDN, 
	KC_LSFT, 		  KC_Z,  KC_X,   KC_C,  KC_V,  KC_B,  KC_N,  KC_M,  KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   KC_END,  
	KC_LCTL, MO(_FL), KC_LALT,                     KC_SPC,                		 KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT),

   /* Keymap _FL: Function Layer
	*/
[_FL] = LAYOUT_SplitBackspace_default(
