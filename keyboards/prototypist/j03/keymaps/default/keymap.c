...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_iso(
                                                                                                                                     KC_MUTE,  KC_PSCR, KC_SCRL, KC_PAUS,
       ...
       KC_LGUI, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_NUHS,          KC_P4,    KC_P5,   KC_P6,   KC_PPLS, 
       KC_LSFT, KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   KC_P1,    KC_P2,   KC_P3,    
       KC_LCTL, MO(1),   KC_LALT,                            KC_SPC,                             KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RIGHT, KC_P0,   KC_PDOT, KC_PENT
    ),

    [1] = LAYOUT_iso(
                                                                                                                                     _______, _______, _______, _______,
       EE_CLR,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_MPLY, _______, _______, _______, _______,
       ...
       _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, MO(2),   KC_VOLU, _______, _______, _______, 
       _______, _______, _______,                            _______,                            _______, _______, KC_MPRV, KC_VOLD, KC_MNXT, _______, _______, _______
    ),

    [2] = LAYOUT_iso(
                                                                                                                                     _______, _______, _______, _______,
       _______, KC_F13,  KC_F14,  KC_F15,  KC_F16,  KC_F17,  KC_F18,  KC_F19,  KC_F20,  KC_F21,  KC_F22,  KC_F23,  KC_F24,  KC_MPRV, _______, _______, _______, _______,
       ...
       _______, _______, _______,                            _______,                            _______, _______, MO(3),   _______, _______, _______, _______, _______
    ),
